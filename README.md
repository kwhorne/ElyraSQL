...
> **Stable release: v1.11.3.** A broad, MySQL-compatible SQL engine: full
...
SELECT VERSION();   -- 8.0.12-ElyraSQL-1.11.3
```
...
```bash
docker run -p 3307:3307 -v elyra:/var/lib/elyrasql ghcr.io/kwhorne/elyrasql:1.11.3
