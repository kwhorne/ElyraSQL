...
> **Stable release: v1.11.2.** A broad, MySQL-compatible SQL engine: full
...
SELECT VERSION();   -- 8.0.12-ElyraSQL-1.11.2
```
...
```bash
docker run -p 3307:3307 -v elyra:/var/lib/elyrasql ghcr.io/kwhorne/elyrasql:1.11.2
